			...
			<div class="col-md-12">
				<ul class="top-header-bar">
					...
					<?php if ( class_exists( 'WooCommerce' ) ) : ?>
						<!-- Cart -->
						<li class="top-cart">
							<a href="<?php echo esc_url( Tyche_Helper::get_woocommerge_page( 'cart' ) ); ?>"><i class="fa fa-shopping-cart"></i> <?php echo pll__(esc_html__( 'Mon Panier','tyche')); 
							?>
					...
					<?php if ( class_exists( 'WooCommerce' ) ) : ?>
						...
						<li class="top-account">
							<a href="<?php echo esc_url( Tyche_Helper::get_woocommerge_page( 'account' ) ); ?>"><i class="fa fa-user"></i> <?php echo pll__(esc_html__( 'Mon compte', 'tyche' )); ?>
							</a>
						</li><!-- / Account -->
					<?php endif; ?>
